{
  ...
  "output": {
    ...
    "headerText": "IMPORTANT: This file contains a summary of the codebase condense into a single file. It is important to review this file to understand the structure and content of the codebase.",
  ...
  "include": ["README.sh", "src/**/*.ts", "test/**/*.ts", "scripts/**/*.ts", "assets/**/**"],
